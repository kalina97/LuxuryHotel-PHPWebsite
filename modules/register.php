...
if(isset($_POST['send'])) {
   ...
   $username = $_POST['username'];
    ...
    $mail->setFrom('kalincevic@gmail.com', 'Mail');
    ...
    $mail->Body    = 'Verifikacija mejla: <a href="http://localhost/NoviSajt/modules/verifikacijaEmail.php?token='.$token.'">LINK VERIFIKACIJE</a>';
