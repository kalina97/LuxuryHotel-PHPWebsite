<section class="site-section">
      <div class="container">
		...
		include "modules/konekcija.php";
		  ...
		  $upitSobe="select * from dvokrevetna d join tipsobe t on d.idTip=t.idTip join cene c on d.idCena=c.idCena join gosti g on d.idGost=g.idGost join kvadratura k on d.idKvadrat=k.idKvadrat join zvezdice z on d.idZvezdice=z.idZvezdice ";
		  $rezultat=$konekcija->query($upitSobe);
		  
          echo '<div id="col2" class="col-md-8 mb-4">';
