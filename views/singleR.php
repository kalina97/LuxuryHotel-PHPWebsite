<section class="site-section">
      <div class="container">
		...
		include "modules/konekcija.php";
		  ...
		  $upitSobe="select * from jednokrevetna j join tipsobe t on j.idTip=t.idTip join cene c on j.idCena=c.idCena join gosti g on j.idGost=g.idGost join kvadratura k on j.idKvadrat=k.idKvadrat join zvezdice z on j.idZvezdice=z.idZvezdice ";
		  $rezultat=$konekcija->query($upitSobe);
		  
          echo '<div id="col1" class="col-md-8 mb-4">';
